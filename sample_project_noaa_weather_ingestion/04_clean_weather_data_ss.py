...
source_table = 'serverless_stable_7lg3y6_catalog.bronze_noaa.forecasts'
...
target_table = "serverless_stable_7lg3y6_catalog.silver_noaa.forecasts_ss"
...
# MAGIC %sql 
# MAGIC SELECT * 
# MAGIC FROM serverless_stable_7lg3y6_catalog.silver_noaa.forecasts_ss
